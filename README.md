...
**Turn a plain-language request into a reviewed Pull Request — automatically.**
...
Each status also has a plain-language label shown on the progress page.
...
`scripts/` tree, including `git/` and `config/`).
