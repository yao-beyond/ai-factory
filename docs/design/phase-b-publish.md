...
- 真正的公網「🚀 一鍵發布上線」保留給未來的**獨立 origin provider**；在 v0 顯示為 `⏳ 一鍵上線（即將推出）`，點選說明可先用「分享連結」。

> 此裁決採 Codex 立場，否決 Gemini 文案中「專案已在網路上公開 / 正式的公開網址 / 任何人點選都能看到」等過度承諾用語。Gemini 的暖心文案（複製鈕、QR、下架確認框、誠實提醒）保留，僅把「公開上線」降級為「分享連結」。
...
- 下架確認框：
  - 標題：要暫時關閉這個連結嗎？
  - 內容：關閉後，其他人點選連結會看到「目前無法瀏覽」。您的專案檔案不會消失，隨時可以再次開啟。
  - 按鈕：`確認關閉` / `先不要，保持開啟`
